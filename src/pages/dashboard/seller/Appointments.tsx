...
import { Calendar, Search, Filter, Clock, CheckCircle, XCircle, AlertTriangle, MapPin, User, Phone, Mail, Building2 } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-2">Manage property viewing appointments with potential buyers</p>
        </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="flex-1">
              <div className="relative">
                ...
                <Input
                  placeholder="Search appointments or buyers..."
                  value={searchTerm}
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500">
                {searchTerm || statusFilter !== 'all'
                  ...
                  : 'Appointments will appear here when buyers schedule property viewings.'
                }
              </p>
            </div>
          )}
      ...
      <Dialog open={detailsDialogOpen} onOpenChange={setDetailsDialogOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Full appointment information and contact details
            </DialogDescription>
          </DialogHeader>
              ...
              <div className="space-y-2">
                ...
                <div>
                  ...
                  <div className="flex flex-col space-y-1 text-sm text-muted-foreground">
                    ...
                    {selectedAppointment.buyer_email && (
                      <div className="flex items-center">
                        <Mail className="h-3 w-3 mr-1" />
                        {selectedAppointment.buyer_email}
                      </div>
