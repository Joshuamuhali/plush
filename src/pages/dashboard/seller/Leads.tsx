...
import { Users, Search, Filter, Building2, Eye, TrendingUp, Clock, CheckCircle } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Lead Activity</h1>
          <p className="text-gray-600 mt-2">Track and manage inquiries for your properties</p>
        </div>
        <Button onClick={() => navigate('/dashboard/seller/overview')}>
          Back to Dashboard
        </Button>
      </div>
                    ...
                    <TableCell>
                      <div className="flex items-center space-x-3">
                        <div className="w-12 h-12 bg-gray-200 rounded-lg flex-shrink-0">
                          {lead.property_images?.[0]?.url ? (
                            <img
                              src={lead.property_images[0].url}
                              alt={lead.property_title}
                        ...
                        <div className="min-w-0 flex-1">
                          <p className="font-medium line-clamp-1">{lead.property_title}</p>
                          <div className="flex items-center text-sm text-muted-foreground">
                            <p className="font-medium text-primary">
                              ZMW {lead.property_price.toLocaleString()}
                            </p>
                            <span className="mx-2">•</span>
                            <p>{lead.property_city}</p>
                          </div>
                        </div>
                      </div>
                    </TableCell>
      ...
      <Card>
        ...
        <CardContent>
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li>• Respond to new leads within 24 hours to increase conversion rates</li>
            <li>• Qualify leads by asking relevant questions about their requirements</li>
            <li>• Schedule property viewings promptly for interested buyers</li>
            <li>• Follow up regularly to maintain engagement and build trust</li>
            <li>• Use the status tracking to organize your sales pipeline effectively</li>
          </ul>
        </CardContent>
      </Card>
    </div>
